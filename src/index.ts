...
import RefsUploadCommand from './commands/references/upload.js';
...
export const COMMANDS = {
  ...
  'references:upload': RefsUploadCommand,
 ...
 */
export type APIv2PageUploadCommands = DocsUploadCommand | RefsUploadCommand;
