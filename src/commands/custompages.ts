...
export default class CustomPagesCommand extends BaseCommand<typeof CustomPagesCommand> {
  ...
  static description =
    'Syncs Markdown files as Custom Pages in your ReadMe project. The path can either a directory or a single Markdown file. The Markdown files will require YAML front matter with certain ReadMe documentation attributes. Check out our docs for more info on setting up your front matter: https://docs.readme.com/main/docs/rdme#markdown-file-setup';
