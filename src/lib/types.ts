                            ...
                            connection: {
                              ...
                              properties: {
                                repository: {
                                  type: 'object',
                                  properties: {
                                    id: { type: 'string', description: 'The stringified external repo id.' },
                                    name: { type: 'string', description: 'The name of the repo.' },
                                    url: { type: 'string', description: 'The url to the repo.' },
                                    organization: {
                                      type: 'object',
                                      properties: {
                                        name: {
                                          type: 'string',
                                          description: 'The name of the organization this repo belongs to.',
                                        },
                                        type: {
                                          type: 'string',
                                          enum: ['User', 'Organization'],
                                          description: 'The type of the organization this repo belongs to.',
                                        },
                                        active: {
                                          type: 'boolean',
                                          default: true,
                                    ...
                                    connected_at: {
                                      ...
                                      format: 'date-time',
                                      description:
                                        'An ISO 8601 formatted date for when the repository was last connected.',
                                    },
                                    connected_by: {
                                      type: 'string',
                                      nullable: true,
                                  ...
                                  required: ['id', 'name', 'url', 'organization', 'connected_at', 'connected_by'],
                                  additionalProperties: false,
                                },
                              },
                              required: ['repository'],
