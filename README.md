...
> [!WARNING]
> Heads up: our new Git offering doesn’t yet support `rdme`. If you’ve chosen to upgrade your project to the new experience, we recommend enabling bi-directional syncing with Git to continue editing your docs and uploading API definitions!
