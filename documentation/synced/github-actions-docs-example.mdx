...
>
> If you are still on our legacy project architecture, please see [our documentation for `rdme@9`](https://docs.readme.com/docs/rdme-legacy). //todo: update callout
