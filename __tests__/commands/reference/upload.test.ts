...
describe('rdme reference upload', () => {
  ...
  describe('given that the file path is a single file', () => {
    it('should create a reference page in ReadMe', async () => {
      const mock = getAPIv2Mock({ authorization })
        .get('/branches/stable/reference/new-doc')
        .reply(404)
        .post('/branches/stable/reference', {
          category: { uri: '/branches/stable/categories/reference/category-slug' },
          slug: 'new-doc',
    ...
    it('should allow for user to specify branch via --branch flag', async () => {
      const mock = getAPIv2Mock({ authorization })
        .get('/branches/1.2.3/reference/new-doc')
        .reply(404)
        .post('/branches/1.2.3/reference', {
          category: { uri: '/branches/1.2.3/categories/reference/category-slug' },
          slug: 'new-doc',
          title: 'This is the document title',
          content: { body: '\nBody\n' },
        })
    ...
    it('should allow for user to specify branch via legacy --version flag', async () => {
      const mock = getAPIv2Mock({ authorization })
        .get('/branches/4.5.6/reference/new-doc')
        .reply(404)
        .post('/branches/4.5.6/reference', {
          category: { uri: '/branches/4.5.6/categories/reference/category-slug' },
          slug: 'new-doc',
          title: 'This is the document title',
          content: { body: '\nBody\n' },
        })
    ...
    describe('given that the --dry-run flag is passed', () => {
      it('should not create anything in ReadMe', async () => {
        const mock = getAPIv2Mock({ authorization }).get('/branches/stable/reference/new-doc').reply(404);
      ...
      it('should not update anything in ReadMe', async () => {
        const mock = getAPIv2Mock({ authorization }).get('/branches/stable/reference/some-slug').reply(200);
      ...
      it('should error out if a non-404 error is returned from the GET request', async () => {
        const mock = getAPIv2Mock({ authorization }).get('/branches/stable/reference/some-slug').reply(500);
    ...
    describe('given that the slug is passed in the frontmatter', () => {
      it('should use that slug to create a page in ReadMe', async () => {
        const mock = getAPIv2Mock({ authorization })
          .get('/branches/stable/reference/some-slug')
          .reply(404)
          .post('/branches/stable/reference', {
            category: { uri: '/branches/stable/categories/reference/some-category-uri' },
            title: 'This is the document title',
            content: { body: '\nBody\n' },
            slug: 'some-slug',
          })
      ...
      it('should use that slug update an existing reference page in ReadMe', async () => {
        const mock = getAPIv2Mock({ authorization })
          .get('/branches/stable/reference/some-slug')
          .reply(200)
          .patch('/branches/stable/reference/some-slug', {
            category: { uri: '/branches/stable/categories/reference/some-category-uri' },
            title: 'This is the document title',
            content: { body: '\nBody\n' },
          })
    ...
    describe('given that the file has frontmatter issues', () => {
      it('should fix the frontmatter issues in the file and create the corrected file in ReadMe', async () => {
        const mock = getAPIv2Mock({ authorization })
          .get('/branches/stable/reference/legacy-category')
          .reply(404)
          .post('/branches/stable/reference', {
            category: {
              uri: '/branches/stable/categories/reference/uri-that-does-not-map-to-5ae122e10fdf4e39bb34db6f',
            },
      ...
      it('should fix the frontmatter issues in the file and insert the proper category mapping', async () => {
        ...
        const mock = getAPIv2Mock({ authorization })
          ...
          .reply(404)
          .post('/branches/stable/reference', {
            category: { uri: '/branches/stable/categories/reference/mapped-uri' },
            slug: 'legacy-category',
            title: 'This is the document title',
            content: { body: '\nBody\n' },
          })
      ...
      it('should warn user if the file has no autofixable issues', async () => {
        const mock = getAPIv2Mock({ authorization })
          .get('/branches/stable/reference/invalid-attributes')
          .reply(404)
          .post('/branches/stable/reference', {
            category: {
              uri: '/branches/stable/categories/reference/some-category-uri',
    ...
    describe('and the command is being run in a CI environment', () => {
      ...
      it('should create a reference page in ReadMe and include `x-readme-source-url` source header', async () => {
        const getMock = getAPIv2MockForGHA({ authorization }).get('/branches/stable/reference/new-doc').reply(404);
    ...
    it('should error out if a non-404 error is returned from the GET request', async () => {
      const mock = getAPIv2Mock({ authorization }).get('/branches/stable/reference/new-doc').reply(500);
  ...
  describe('given that the file path is a directory', () => {
    it('should create a reference page in ReadMe for each file in the directory and its subdirectories', async () => {
      const mock = getAPIv2Mock({ authorization })
        .get('/branches/stable/reference/simple-doc')
        .reply(404)
        .post('/branches/stable/reference', {
          slug: 'simple-doc',
          title: 'This is the document title',
        ...
        .reply(201, {})
        .get('/branches/stable/reference/another-doc')
        .reply(404)
        .post('/branches/stable/reference', {
          slug: 'another-doc',
    ...
    it('should update existing reference pages in ReadMe for each file in the directory and its subdirectories', async () => {
      const mock = getAPIv2Mock({ authorization })
        .get('/branches/stable/reference/simple-doc')
        .reply(200)
        .patch('/branches/stable/reference/simple-doc', {
          title: 'This is the document title',
          content: { body: '\nBody\n' },
        })
        .reply(201, {})
        .get('/branches/stable/reference/another-doc')
        .reply(200)
        .patch('/branches/stable/reference/another-doc', {
          title: 'This is another document title',
          category: { uri: '/branches/stable/categories/reference/category-slug' },
          content: { body: '\nAnother body\n' },
        })
    ...
    it('should handle complex frontmatter', async () => {
      const mock = getAPIv2Mock({ authorization })
        .get('/branches/stable/reference/basic')
        .reply(200)
        .patch('/branches/stable/reference/basic', {
          title: 'This is the document title',
          category: { uri: '/branches/stable/categories/reference/category-slug' },
        ...
        .reply(201, {})
        .get('/branches/stable/reference/link')
        .reply(200)
        .patch('/branches/stable/reference/link', {
          title: 'This is the document title',
          category: { uri: '/branches/stable/categories/reference/category-slug' },
          content: {
            body: '\nBody\n',
    ...
    describe('given that the directory contains parent/child docs', () => {
      it('should upload parents before children', async () => {
        const mock = getAPIv2Mock({ authorization })
          .get('/branches/stable/reference/child')
          .reply(404)
          .post('/branches/stable/reference', {
            slug: 'child',
            title: 'Child',
            parent: { uri: '/branches/stable/reference/parent' },
            content: { body: '\nBody\n' },
          })
          .reply(201, {})
          .get('/branches/stable/reference/friend')
          .reply(404)
          .post('/branches/stable/reference', {
            slug: 'friend',
            title: 'Friend',
          ...
          .reply(201, {})
          .get('/branches/stable/reference/parent')
          .reply(404)
          .post('/branches/stable/reference', {
            slug: 'parent',
            title: 'Parent',
            parent: { uri: '/branches/stable/reference/grandparent' },
            content: { body: '\nBody\n' },
          })
          .reply(201, {})
          .get('/branches/stable/reference/grandparent')
          .reply(404)
          .post('/branches/stable/reference', {
            slug: 'grandparent',
            title: 'Grandparent',
    ...
    it('should handle a mix of creates and updates and failures and skipped files', async () => {
      const mock = getAPIv2Mock({ authorization })
        ...
        .get('/branches/stable/reference/legacy-category')
        .reply(200)
        .patch('/branches/stable/reference/legacy-category', {
          category: { uri: '/branches/stable/categories/reference/uri-that-does-not-map-to-5ae122e10fdf4e39bb34db6f' },
          title: 'This is the document title',
          content: { body: '\nBody\n' },
        })
        .reply(201, {})
