...
rdme openapi validate test/__fixtures__/ref-oas/petstore.json

# ... your local test command will look like this:
bin/dev.js openapi validate test/__fixtures__/ref-oas/petstore.json
```
...
```sh
npm run build
bin/run.js openapi validate test/__fixtures__/ref-oas/petstore.json
```
